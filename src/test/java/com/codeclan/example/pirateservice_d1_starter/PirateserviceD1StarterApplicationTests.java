...
//	}
	...
	public void createPirateAndShip(){
		Ship ship = new Ship("Black Diamond");
		shipRepository.save(ship);
		Pirate pirate = new Pirate("Kat", "Kmiotek", 33, ship);
		pirateRepository.save(pirate);
	}
	@Test
	public void addPiratesAndRaids() {
		...
		Pirate pirate1 = new Pirate("Alan", "Currie", 35, ship);
		pirateRepository.save(pirate1);

		Raid raid1 = new Raid("Porto", 100);
